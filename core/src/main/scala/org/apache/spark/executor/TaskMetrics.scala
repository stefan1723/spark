...
//          case blockStatus: java.util.List[_] =>
//            if (blockStatus.size() > 0 && blockStatus.get(0).isInstanceOf[(BlockId, BlockStatus)])
//              {
//              tm.setUpdatedBlockStatuses(
//                blockStatus.asInstanceOf[java.util.List[(BlockId, BlockStatus)]])
//            }
